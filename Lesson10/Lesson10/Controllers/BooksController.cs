...
namespace Lesson10.Controllers
{
    ...
    {
        private readonly Lesson10Context _context;

        public BooksController(Lesson10Context context)
        {
            _context = context;
        }
        ...
        {
            var lesson10Context = _context.Book.Include(b => b.Author);
            return View(await lesson10Context.ToListAsync());
        }
